    ...
    <div className="h-full animate-fade-in-up">
      <div className="bg-[#f6f6ff] rounded-2xl shadow-md border border-slate-100 overflow-hidden flex flex-col h-full">
        <div className="p-4 flex justify-between items-center bg-[#144f36] text-white">
          ...
          <Link to={'/notes/sub-category/add'} className="bg-white/10 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-white/20 transition-colors flex items-center gap-2 border border-white/30">
            <span>+ Add New</span>
          </Link>
        </div>
                    ...
                    <tr key={row._id} className="border-b border-slate-200 hover:bg-slate-50">
                      ...
                      <td className="px-4 py-3 align-middle">
                        <div className="flex gap-1.5">
                          <Link to={`/notes/sub-category/add`} state={{ editSubCategory: row }} className="inline-block bg-[#28a745] text-white p-1.5 rounded-full hover:bg-[#218838] transition-colors">
                            <Edit2 size={14} />
                          </Link>
